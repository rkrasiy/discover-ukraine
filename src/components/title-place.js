                   ...
                   <div className="flex flex-row gap-8">
                        ...
                        <div className="flex flex-row gap-8 flex-auto">
                            ...
                            <div className="flex-auto flex flex-col gap-4 relative">
                                <img src="./no-image.png" className={`rounded-3xl w-[110px] h-[125px] object-cover`} />        
                                <img src="./no-image.png" className={`rounded-3xl w-[107px] h-[118px] object-cover`} />        
                                <img src="./no-image.png" className={`rounded-3xl w-[197px] h-[157px] object-cover absolute left-[131px] top-[22%]`} />        
